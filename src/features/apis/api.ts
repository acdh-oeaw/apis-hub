...
export function useGetApisEntitySuggestionsByType<TData = GetApisEntitySuggestionsByType.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-entity-suggestions-by-type", params),
		queryFn: () => {
			assert(params != null);
...
export function useGetApisEntityById<TData = GetApisEntityById.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-entity-by-id", params),
		queryFn: () => {
			assert(params != null);
...
export function useGetApisEntitiesByType<TData = GetApisEntitiesByType.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-entities-by-type", params),
		queryFn: () => {
			assert(params != null);
...
export function useGetApisRelationTypes<TData = GetApisRelationTypes.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-relation-types", params),
		queryFn: () => {
			assert(params != null);
...
export function useGetApisRelationById<TData = GetApisRelationById.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-relation-by-id", params),
		queryFn: () => {
			assert(params != null);
...
export function useGetApisRelations<TData = GetApisRelations.Response>(
	...
	return useQuery({
		queryKey: createQueryCacheKey(instance.id, "apis-relations", params),
		queryFn: () => {
			assert(params != null);
