...
const apis: ApisInstanceConfig = {
	...
	url: "https://apis.acdh.oeaw.ac.at",
...
const ica: ApisInstanceConfig = {
	...
	url: "https://ica-db.acdh.oeaw.ac.at",
...
const mine: ApisInstanceConfig = {
	id: "mine",
	title: "MINE",
	subtitle: "Members, Institutions, Networks, Events (History of the Austrian Academy of Sciences)",
	description:
	...
	url: "https://paas.acdh-dev.oeaw.ac.at/",
	image: "/assets/images/mine.svg",
	access: { type: "restricted", user: null },
};

export const config = {
	instances: { apis, ica, mpr, pmb, mine },
};
